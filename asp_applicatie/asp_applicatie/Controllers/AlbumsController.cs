...
namespace asp_applicatie.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public AlbumsController(asp_applicatieContext context)
        {
            _context = context;
        }
        ...
        {
            var asp_applicatieContext = _context.Album.Include(a => a.artist);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'asp_applicatieContext.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
