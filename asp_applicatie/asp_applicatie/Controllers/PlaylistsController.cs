...
namespace asp_applicatie.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public PlaylistsController(asp_applicatieContext context)
        {
            _context = context;
        }
        ...
        {
            var asp_applicatieContext = _context.Playlist.Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("PlaylistId,Name,IsPrivate,UserId,Status")] Playlist playlist)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<User>(), "UserId", "UserId", playlist.UserId);
            return View(playlist);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'asp_applicatieContext.Playlist'  is null.");
            }
            var playlist = await _context.Playlist.FindAsync(id);
            if (playlist != null)
            {
